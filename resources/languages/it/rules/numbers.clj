(
  "number (0..19)"
  #"(?i)(zero|nulla|niente|uno|un|due|tredici|tre|quattro|cinque|sei|sette|otto|nove|dieci|undici|dodici|quattordici|quindici|sedici|diciassette|diciotto|diciannove)"
  {:dim :number
   :integer true
