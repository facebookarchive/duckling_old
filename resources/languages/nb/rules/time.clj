(
  ...
  "constitution day";17th of may in Norway
  #"(?i)grunnlovsdag(en)"
  (month-day 5 17)
  ...
  "season"
  #"(?i)sommer(en)" ;could be smarter and take the exact hour into account... also some years the day can change
  ...
  [#(and (= :time-of-day (:form %)) (not (:latent %))) #"\-|tilogmed|til" {:form :time-of-day}] ; Prevent set alarm 1 to 5pm
  (interval %1 %3 true)
