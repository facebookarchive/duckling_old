(
 ...
 ;;
  ...
  "ordinals written (first..19th)"
  #"(?i)(перв|втор|трет|четверт|пят|шест|седьм|восьм|девят|десят|одинадцат|двенадцат|тринадцат|четырнадцат|пятнадцат|шестнадцат|семнадцат|восемнадцат|девятнадцат|двадцат)(ый|ой|ий|ая|ое|ья|ье|ую|ые|ых)"
  {:dim :ordinal
   :value (get {"перв" 1 "втор" 2 "трет" 3 "пятнадцат" 15 "шестнадцат" 16 "девятнадцат" 19 "четверт" 4 "пят" 5 "шест" 6 "седьм" 7 "восьм" 8 "девят" 9 "десят" 10 "одинадцат" 11 "двенадцат" 12 "тринадцат" 13 "четырнадцат" 14 "пятнадцат" 15 "шестнадцат" 16 "семнадцат" 17 "восемнадцат" 18 "девятнадцат" 19 "двадцат" 20}
  (-> %1 :groups first .toLowerCase))}

  "ordinal (digits)"
  #"0*(\d+)(-)?(?i)(ый|ой|ий|ая|ое)"
  {:dim :ordinal
