(
  ...
  {:dim :number
   :integer true
   :val (get {"cero" 0 "zero" 0 "un" 1 "uno" 1 "una" 1 "dos" 2 "tres" 3 "trés" 3 "cuatro" 4 "cinco" 5
  ...
  {:dim :number
   :integer true
   :val (get {"veinte" 20 "treinta" 30 "cuarenta" 40 "cincuenta" 50 "sesenta" 60 "setenta" 70 "ochenta" 80 "noventa" 90}
             (-> %1 :groups first .toLowerCase))}
  ...
  [(integer 20 90 #(#{20 30 40 50 60 70 80 90} (:val %))) #"(?i)y" (integer 1 9)]
  {:dim :number
   :integer true
   :val (+ (:val %1) (:val %3))}
  ...
  {:dim :number
   :integer true
   :val (get {"dieciseis"16 "diesiseis"  16 "diesiséis"  16 "dieciséis" 16 "diecisiete" 17 "dieciocho" 18 "diecinueve" 19 "veintiuno" 21 "veintidos" 22 "veintitres" 23 "veintitrés" 23 "veinticuatro" 24 "veinticinco" 25
  ...
  {:dim :number
   :integer true
   :val (get {"cien" 100 "cientos" 100 "ciento"  100 "doscientos" 200 "trescientos" 300 "cuatrocientos" 400 "quinientos" 500 "seiscientos" 600 "setecientos" 700 "ochocientos" 800 "novecientos" 900 "mil" 1000}
              (-> %1 :groups first .toLowerCase))}
