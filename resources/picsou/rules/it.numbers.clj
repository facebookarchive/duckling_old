(
  ...
  {:dim :number
   :integer true
   :val (get {"zero" 0 "nulla" 0 "niente" 0 "uno" 1 "due" 2 "tre" 3 "quattro" 4 "cinque" 5 "sei" 6 "sette" 7 "otto" 8 "nove" 9 "dieci" 10 "undici" 11 "dodici" 12 "tredici" 13 "quattordici" 14 "quindici" 15 "sedici" 16 "diciassette" 17 "diciotto" 18 "diciannove" 19}
  ...
  {:dim :number
   :integer true
   :val (get {"venti" 20 "trenta" 30 "quaranta" 40 "cinquanta" 50 "sessanta" 60 "settanta" 70 "ottanta" 80 "novanta" 90}
             (-> %1 :groups first .toLowerCase))}
  
  "number (21..29 31..39 41..49 51..59 61..69 71..79 81..89 91..99)"
  [(integer 20 90 #(#{20 30 40 50 60 70 80 90} (:val %))) #"(?i)e" (integer 1 9)]
  {:dim :number
   :integer true
   :val (+ (:val %1) (:val %3))}
  ...
  {:dim :number
   :integer true
   :val (get {"cento" 100 "duecento" 200 "trecento" 300 "quattrocento" 400 "cinquecento" 500 "seicento" 600 "settecento" 700 "ottocento" 800 "novecento" 900 "mille" 1000" mila" 1000}
              (-> %1 :groups first .toLowerCase))}
